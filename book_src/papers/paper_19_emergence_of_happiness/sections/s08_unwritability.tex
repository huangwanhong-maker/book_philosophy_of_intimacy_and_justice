...
\begin{itemize}
  ...
  \item (And \xref{sec:dynamics}, ``insufficiency-cum-bearing,'' is the formal-dress version of the same gesture: exhausting the form to display the form's not-reaching.)
\end{itemize}

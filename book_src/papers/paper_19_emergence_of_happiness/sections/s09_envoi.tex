...
\noindent
By \xref{sub:unwrit-close}, the fitting end is not a conclusion. What follows is not a summary, makes no further claim, and states no thesis---any added signifier would weaken the needlessness of \xref{sub:silence-three} and the laying-down of the pen of \xref{sub:unwrit-close}. The envoi performs only an \emph{indication} (a turning-toward, not a statement) and an \emph{unclosing image}. It does not speak \emph{about} happiness; it enacts having no more need to speak. The ``we'' is left anonymous---a bare structure, into which any reader may enter their own afternoon.

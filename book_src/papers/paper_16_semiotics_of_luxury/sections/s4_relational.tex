...
\label{subsec:dual_luxury}

\noindent
The upper-left cell---the long-saved diamond ring---deserves particular attention, because it represents the most complex case for the theory of relational luxury and anticipates the justice theory of \xref{sec:justice}.

...
\label{subsec:misrecognition_study}
...
\noindent
The empirical study of relational luxury faces methodological challenges that parallel those identified in \pinkref{Paper~XV} \citep{paperxv} and that must be honestly acknowledged.
